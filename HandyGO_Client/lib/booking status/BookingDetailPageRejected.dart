...
class BookingDetailPageRejected extends StatefulWidget {
  final String bookingId;
  final String userId;

  const BookingDetailPageRejected({
    Key? key,
  ...
  @override
  _BookingDetailPageRejectedState createState() =>
      _BookingDetailPageRejectedState();
}

class _BookingDetailPageRejectedState extends State<BookingDetailPageRejected> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Rejected Booking', style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_bookingDetails.containsKey('rejection_reason') && 
                _bookingDetails['rejection_reason'] != null &&
                _bookingDetails['rejection_reason'].toString().isNotEmpty)
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildSectionTitle('Rejection Reason', icon: Icons.info_outline),
            SizedBox(height: 16),
            ...
            Container(
              ...
              child: Text(
                _bookingDetails['rejection_reason'] ?? 'No reason provided',
                style: TextStyle(
                  fontSize: 14,
                  color: AppTheme.textBody,
                  height: 1.5,
